      ...
      entries: [
        {
          ...
          description:
            "ก่อนจะรู้จักคำว่า \"Infrastructure\" ผมคือเด็กที่ชอบแกะของเล่นทุกอย่างที่จับได้ แล้วก็พยายาม (บางทีก็ล้มเหลว) ประกอบมันกลับคืน แผนการเรียนวิทย์-คณิตให้พื้นที่กับความอยากรู้แบบนี้ และทำให้ \"ทำไมมันถึงทำงานแบบนี้\" กลายเป็นนิสัยติดตัวไปเลย",
